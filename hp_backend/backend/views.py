    ...
    def post(self, request):
        try:
            ...
            if date:
                ...
                bpc = BusinessPC.objects.all().values('product', 'part_no', "specification_details", "processor",
                                                      "screen_size", "warranty", "ram", "hard_disk", "operating_system",
                                                      "screen", "price")
                work = WorkStation.objects.all().values('product', 'part_no', "specification_details", "processor",
                                                        'graphics', "warranty", "ram", "hard_disk", "odd", "price")
                note = NoteBook.objects.all().values('product', 'part_no', "specification_details", "processor",
                                                     "screen_size", "warranty", "ram", "hard_disk", "operating_system",
                                                     "screen", "price")
                payload['business'] = bpc
                payload['notebook'] = note
